 ...
 */
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        binding.customControlButton.setOnClickListener(v -> YLTools.swapFragmentWithAnim(this, ControlButtonFragment.class, ControlButtonFragment.TAG, null));
        binding.openMainDirButton.setOnClickListener(v -> {
            ...
            YLTools.swapFragmentWithAnim(this, FilesFragment.class, FilesFragment.TAG, bundle);
        });
        ...
        binding.shareLogsButton.setOnClickListener(v -> YLTools.shareLogs(requireActivity()));
        binding.hostServerButton.setOnClickListener(v -> YLTools.swapFragmentWithAnim(this, HostServerFragment.class, HostServerFragment.TAG, null));

        binding.version.setOnClickListener(v -> {
            if (!isTaskRunning()) {
                YLTools.swapFragmentWithAnim(this, VersionsListFragment.class, VersionsListFragment.TAG, null);
            } else {
        ...
        binding.managerProfileButton.setOnClickListener(v -> {
            if (!isTaskRunning()) {
                ...
                YLTools.swapFragmentWithAnim(this, VersionManagerFragment.class, VersionManagerFragment.TAG, null);
            } else {
