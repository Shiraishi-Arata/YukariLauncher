...
import com.arata.yukarilauncher.databinding.FragmentVersionConfigBinding
...
import com.arata.yukarilauncher.feature.version.VersionConfig.CREATOR.getIsolationString
import com.arata.yukarilauncher.feature.version.VersionConfig.IsolationType
import com.arata.yukarilauncher.feature.version.VersionsManager.getCurrentVersion
...
import com.arata.yukarilauncher.setting.AllSettings.Companion.versionIsolation
import com.arata.yukarilauncher.task.Task
import com.arata.yukarilauncher.task.TaskExecutors.Companion.getAndroidUI
...
import com.arata.yukarilauncher.utils.file.FileTools.Companion.copyFileInBackground
...
class VersionConfigFragment : FragmentWithAnim(R.layout.fragment_version_config), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            gameArgsEdit.doAfterTextChanged { text ->
    ...
    override fun onClick(v: View?) {
        ...
        binding.apply {
            when (v) {
                cancelButton -> YLTools.onBackPressed(activity)
                saveButton -> {
                    save()
