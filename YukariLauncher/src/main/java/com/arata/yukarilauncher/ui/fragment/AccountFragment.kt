...
import com.arata.yukarilauncher.databinding.FragmentAccountBinding
import com.arata.yukarilauncher.databinding.ItemOtherServerBinding
import com.arata.yukarilauncher.databinding.ViewAddOtherServerBinding
...
import com.arata.yukarilauncher.feature.accounts.LocalAccountUtils.CheckResultListener
import com.arata.yukarilauncher.feature.accounts.LocalAccountUtils.Companion.checkUsageAllowed
import com.arata.yukarilauncher.feature.accounts.LocalAccountUtils.Companion.openDialog
import com.arata.yukarilauncher.feature.accounts.OtherLoginHelper
import com.arata.yukarilauncher.feature.log.Logging
import com.arata.yukarilauncher.feature.login.OtherLoginApi
import com.arata.yukarilauncher.feature.login.Servers
...
import com.arata.yukarilauncher.ui.dialog.OtherLoginDialog
import com.arata.yukarilauncher.ui.dialog.TipDialog
import com.arata.yukarilauncher.ui.layout.AnimRelativeLayout
import com.arata.yukarilauncher.ui.subassembly.account.AccountAdapter
import com.arata.yukarilauncher.ui.subassembly.account.AccountAdapter.AccountUpdateListener
import com.arata.yukarilauncher.ui.subassembly.account.AccountViewWrapper
import com.arata.yukarilauncher.ui.subassembly.account.SelectAccountListener
...
class AccountFragment : FragmentWithAnim(R.layout.fragment_account), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        mProgressDialog = YLTools.createTaskRunningDialog(binding.root.context)
        return binding.root
    }
    ...
    override fun onClick(v: View) {
        ...
        binding.apply {
            when (v) {
                returnButton -> YLTools.onBackPressed(activity)
                addServer -> {
