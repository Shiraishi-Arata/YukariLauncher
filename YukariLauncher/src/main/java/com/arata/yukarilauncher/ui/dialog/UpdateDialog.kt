...
class UpdateDialog(context: Context, private val launcherVersion: LauncherVersion) :
    ...
    private fun init() {
        binding.apply {
            ...
            YLTools.getWebViewAfterProcessing(description)
            ...
            updateButton.setOnClickListener {
                dismiss()
                runInUIThread {
                    Toast.makeText(context, context.getString(R.string.update_downloading_tip, "Google Drive"), Toast.LENGTH_SHORT).show()
                }
