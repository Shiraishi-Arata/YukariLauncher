...
class ErrorActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.shareLog.setOnClickListener { YLTools.shareLogs(this) }
    ...
    private fun showGameCrash(extras: Bundle) {
        ...
        val simpleCrashInfo = if (isSignal) "Fatal signal $code" else "Exit code $code"
        val latestLogText = loadLatestLog()
        ...
        binding.apply {
            ...
            this.errorText.apply {
                text = latestLogText ?: simpleCrashInfo
                textSize = 14f
            }
    ...
    private fun loadLatestLog(): String? {
        return runCatching {
            ...
            latestLogFile.readText().takeIf { it.isNotBlank() }
        }.getOrNull()
    }
