...
object FilterConfig {
    ...
    fun getSections(platform: Platform, classify: Classify): List<FilterSection> {
        val modloaderSection = getModloaderSection()
        return when (platform) {
            Platform.CURSEFORGE -> listOf(modloaderSection) + getCurseForgeSections(classify)
            Platform.MODRINTH -> listOf(modloaderSection) + getModrinthSections(classify)
        }
    }
    ...
    private val curseforgeModCategories = listOf(
        FilterOption(R.string.category_addons, listOf(Category.MOD_ADVENTURE, Category.MOD_MAGIC, Category.MOD_TECHNOLOGY, Category.MOD_UTILITY, Category.MOD_STORAGE, Category.MOD_EQUIPMENT, Category.MOD_FOOD, Category.MOD_FARMING, Category.MOD_ORES_RESOURCES, Category.MOD_STRUCTURES), listOf(
            FilterOption(R.string.category_ae2, listOf(Category.MOD_ADVENTURE)),
            FilterOption(R.string.category_blood_magic, listOf(Category.MOD_MAGIC)),
            FilterOption(R.string.category_buildcraft, listOf(Category.MOD_TECHNOLOGY)),
            FilterOption(R.string.category_crafttweaker, listOf(Category.MOD_UTILITY)),
            FilterOption(R.string.category_create, listOf(Category.MOD_TECHNOLOGY)),
            FilterOption(R.string.category_farmers_delight, listOf(Category.MOD_FOOD)),
            FilterOption(R.string.category_forestry, listOf(Category.MOD_FARMING)),
            FilterOption(R.string.category_galacticraft, listOf(Category.MOD_ADVENTURE)),
            FilterOption(R.string.category_industrial_craft, listOf(Category.MOD_TECHNOLOGY)),
            FilterOption(R.string.category_integrated_dynamics, listOf(Category.MOD_TECHNOLOGY)),
            FilterOption(R.string.category_kubejs, listOf(Category.MOD_UTILITY)),
            FilterOption(R.string.category_refined_storage, listOf(Category.MOD_STORAGE)),
            FilterOption(R.string.category_skyblock, listOf(Category.MOD_ADVENTURE)),
            FilterOption(R.string.category_thaumcraft, listOf(Category.MOD_MAGIC)),
            FilterOption(R.string.category_thermal_expansion, listOf(Category.MOD_TECHNOLOGY)),
            FilterOption(R.string.category_tinkers_construct, listOf(Category.MOD_EQUIPMENT)),
            FilterOption(R.string.category_twilight_forest, listOf(Category.MOD_ADVENTURE)),
        )),
        ...
        FilterOption(R.string.category_bug_fixes, listOf()),
        FilterOption(R.string.category_cosmetic, listOf(Category.MOD_DECORATION)),
        FilterOption(R.string.category_creative_mode, listOf()),
        FilterOption(R.string.category_education, listOf()),
        FilterOption(R.string.category_food, listOf(Category.MOD_FOOD)),
        FilterOption(R.string.category_horror, listOf()),
        ...
        FilterOption(R.string.category_mcreator, listOf()),
        FilterOption(R.string.category_miscellaneous, listOf(Category.MOD_UTILITY)),
        FilterOption(R.string.category_modjam, listOf()),
        ...
        FilterOption(R.string.category_technology, listOf(Category.MOD_TECHNOLOGY), listOf(
            ...
            FilterOption(R.string.category_genetics, listOf()),
            FilterOption(R.string.category_player_transport, listOf()),
            FilterOption(R.string.category_processing, listOf()),
        )),
        FilterOption(R.string.category_twitch_integration, listOf()),
    ...
    private val curseforgeModpackCategories = listOf(
        ...
        FilterOption(R.string.category_expert, listOf()),
        ...
        FilterOption(R.string.category_rlcraft, listOf()),
    ...
    private val curseforgeShaderCategories = listOf(
        ...
        FilterOption(R.string.category_photo_realistic, listOf(Category.SHADER_REALISTIC)),
    ...
    private val modrinthModCategories = listOf(
        FilterOption(R.string.category_adventure, listOf(Category.MOD_ADVENTURE)),
        FilterOption(R.string.category_cursed, listOf()),
        FilterOption(R.string.category_decoration, listOf(Category.MOD_DECORATION)),
        FilterOption(R.string.category_economy, listOf()),
        ...
        FilterOption(R.string.category_magic, listOf(Category.MOD_MAGIC)),
        FilterOption(R.string.category_management, listOf()),
        FilterOption(R.string.category_minigame, listOf()),
        FilterOption(R.string.category_mobs, listOf(Category.MOD_MOBS)),
        FilterOption(R.string.category_optimization, listOf(Category.MOD_OPTIMIZATION)),
    ...
    private val modrinthResolution = listOf(
        FilterOption(R.string.category_8x_or_lower, listOf()),
        FilterOption(R.string.category_16x, listOf(Category.RP_16X)),
        FilterOption(R.string.category_32x, listOf(Category.RP_32X)),
        FilterOption(R.string.category_48x, listOf()),
        FilterOption(R.string.category_64x, listOf(Category.RP_64X)),
        FilterOption(R.string.category_128x, listOf(Category.RP_128X)),
        FilterOption(R.string.category_256x, listOf(Category.RP_256X)),
        FilterOption(R.string.category_512x_or_higher, listOf(Category.RP_512X)),
