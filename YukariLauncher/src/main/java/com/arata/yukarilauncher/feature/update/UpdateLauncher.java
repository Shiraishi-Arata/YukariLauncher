...
import static com.arata.yukarilauncher.task.TaskExecutors.runInUIThread;
import static com.arata.yukarilauncher.utils.file.FileTools.formatFileSize;
import static com.arata.yukarilauncher.utils.path.UrlManager.TIME_OUT;
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                if (!response.isSuccessful()) {
                    ...
                    try (InputStream inputStream = response.body().byteStream();
                        ...
                        final long[] lastTime = {YLTools.getCurrentTimeMillis()};
