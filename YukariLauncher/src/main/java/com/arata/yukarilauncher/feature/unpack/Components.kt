 ...
 */
enum class Components(val component: String, val displayName: String, val summary: Int?, val privateDirectory: Boolean, val downloadUrl: String? = null) {
    ...
    LWJGL3("lwjgl/3.3.6", "LWJGL 3.3.6", R.string.splash_screen_lwjgl, true, "https://github.com/Shiraishi-Arata/Yukari-Fixes/releases/download/lwjgl/3.3.6.zip"),
    LWJGL341("lwjgl/3.4.1", "LWJGL 3.4.1", R.string.splash_screen_lwjgl, true, "https://github.com/Shiraishi-Arata/Yukari-Fixes/releases/download/lwjgl/3.4.1.zip"),
